...
banner "=== [1/7] Auto-formatting with Ruff ==="
...
if command -v gitleaks &> /dev/null; then
    banner "\n=== [2/7] Scanning for exposed API keys ==="
...
banner "\n=== [3/7] Running Parallel Syntax Check ==="
...
banner "\n=== [5/7] Running Parallel Unit Tests ==="
...
if command -v swift &> /dev/null; then
    banner "\n=== [6/7] Linting and testing the Swift package ==="
    ...
    banner "\n=== [7/7] Comparing ksp-swift-cli dump against ksp-dump ==="
    ...
    banner "\n=== [6/7] No swift on PATH -- skipping the swift/ package ==="
fi
